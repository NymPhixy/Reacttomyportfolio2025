        ...
        <div className="z-10 px-4 w-full flex flex-col items-center justify-center gap-6 sm:gap-12 max-w-5xl mx-auto">
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-xl sm:text-2xl text-gray-200 font-light max-w-2xl mx-auto">
              Transforming ideas into intuitive, engaging digital experiences
              that solve real problems.
            </p>

            {/* Value Proposition */}
            <p className="text-base sm:text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
              I combine UX research, visual design, and modern front-end
              development to create digital products that users love. Currently
              studying Communication & Multimedia Design at Hanze Groningen.
            </p>
          ...
          <div className="w-full pt-8 sm:pt-12">
            <p className="text-center text-sm sm:text-base text-gray-300 mb-4">
              Learn more about me in this short introduction:
            </p>
